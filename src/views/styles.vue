<template>
  <div class="main">
    <Row>
      <Col :span="4"><span class="title">三角形 - 正三角</span></Col>
      <Col :span="12"><div class="z-triangle"></div></Col>
    </Row>
    <Row>
      <Col :span="4"><span class="title">三角形 - 倒三角</span></Col>
      <Col :span="12"><div class="d-triangle"></div></Col>
    </Row>
    <Row>
      <Col :span="4"><span class="title">虚线</span></Col>
      <Col :span="12"><div class="d-dash">把酒祝东风，且共从容。垂杨紫陌洛城东。总是当时携手处，游遍芳丛。
聚散苦匆匆，此恨无穷。今年花胜去年红。可惜明年花更好，知与谁同。</div></Col>
    </Row>
    <Row>
      <Col :span="4"><div class="title">文字超出省略号</div></Col>
    </Row>
    <Row>
      <Col :span="4"><div class="title">单行文字超出省略号</div></Col>
      <Col :span="12"><div class="singleEllipsis">花似伊。柳似伊。花柳青春人别离。低头双泪垂。 长江东。长江西。两岸鸳鸯两处飞。相逢知几时。</div></Col>
    </Row>
    <Row>
      <Col :span="4"><div class="title">多行文字超出省略号</div></Col>
      <Col :span="12"><div class="moreEllipsis">
...
料峭春风吹酒醒，微冷。山头斜照却相迎，回首向来萧瑟处，归去，也无风雨也无晴。
    ...
    <Row>
      <Col :span="4"><div class="title">滚动条</div></Col>
      <Col :span="12"><div class="scroll-container">
        莫听穿林打叶声，何妨吟啸且徐行。竹杖芒鞋轻胜马，谁怕？一蓑烟雨任平生。
料峭春风吹酒醒，微冷。山头斜照却相迎，回首向来萧瑟处，归去，也无风雨也无晴。
        庭院深深深几许？杨柳堆烟，帘幕无重数。玉勒雕鞍游冶处，楼高不见章台路。
        雨横风狂三月暮，门掩黄昏，无计留春住。泪眼问花花不语，乱红飞过秋千去。
    ...
    <Row>
      <Col :span="4"><div class="title">卡券效果</div></Col>
      <Col :span="12">
    ...
    <Row>
      <Col :span="4"><div class="title">阴影</div></Col>
    </Row>
    <Row>
      <Col :span="4"><div class="title">常见阴影</div></Col>
      <Col :span="12"><div class="shadow-content">
    ...
    <Row>
      <Col :span="4"><div class="title">不规则形状阴影</div></Col>
      <Col :span="12"><div class="shadow-content">
    ...
    <Row>
      <Col :span="4"><div class="title">时间轴</div></Col>
      <Col :span="16">
